...
const [
  ...
  import(`file://${libDir}/searchConfigs.js`),
  import(`file://${libDir}/groupFilesByConfig.js`),
  import(`file://${libDir}/generateTasks.js`),
  import(`file://${libDir}/normalizePath.js`),
  import(`file://${libDir}/getSpawnedTasks.js`),
])
